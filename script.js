 ...
 */
const zenQuotes = [
    "When all you do comes out of emptiness, your life is one of peace and happiness.\n\nWhen you lose it, you lose everything.\n So just remain empty.",
    "Resist the call to go unconscious.",
    "Discipline not excuses.",
    "From emptiness comes the most wonderous unfoldment of doing.\nEverything becomes so clear and ridiculously simple.",
    "Enjoy and be one with your work, then the feeling that any task is a nuisance will leave you.",
    "Don't do any task to get it over with. Do it slowly, without rushing and in emptiness.",
    "What is happiness?\nA quiet and empty mind.",
    "Whatever is born out of time let life take care of that.\nLet life take care of life.\nJust keep quiet and let your mind rest inside your heart.",
    "The greatest step towards a life of happiness and simplicity is to let go.",
    "Liberation is to be\n firmly established as nothing.",
    "Go for the greater, and the lesser will be taken care of.",
    "My most auspicious advice:\nRemain empty",
    "Keep quiet inside your Being.\nDon't worry about anything in this world and your eyes shine bright again.",
    "Life is inviting you:\n Slow down in me.\n Move in me, as me,\nin this holy oneness."
];
